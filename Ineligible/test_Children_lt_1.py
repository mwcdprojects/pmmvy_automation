...
class CHILDRENlt1(unittest.TestCase):
    def setUp(self):
        self.email = ""
        self.name = ""
        self.pwd = ""
    ...
    def test_01(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="NameAsInIDCard"]').send_keys('Sagarika')
        ...
        # Husband's name
        self.driver.find_element_by_xpath('//*[@id="FNameAsInIDCard"]').send_keys('Sushanth')
        ...
        self.driver.find_element_by_xpath('//*[@id="AddressLine1"]').send_keys('803')
        time.sleep(3)
        self.driver.find_element_by_xpath('//*[@id="AddressLine2"]').click()
        self.driver.find_element_by_xpath('//*[@id="AddressLine2"]').send_keys('17th Cross')
