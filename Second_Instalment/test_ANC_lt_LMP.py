...
class ANCLTLMP(unittest.TestCase):
    def setUp(self):
        self.email = ""
        self.name = ""
        self.pwd = ""
    ...
    def test_01_ANCLTLMP(self):
        ...
        time.sleep(5)
        assert element.text == 'Date of ANC must not be earlier than Date of Reg of MCP card. Please enter the correct date'
        print(element.text)
