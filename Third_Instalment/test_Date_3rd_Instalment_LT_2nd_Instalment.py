...
class thirdclaim(unittest.TestCase):
    ...
    def test_01_aadhaar_provided(self):
        ...
        element = self.driver.find_element_by_xpath('//*[@id="frm"]/div[8]/div/span[3]/span')
        assert element.text == 'Third Instalment date should not be less than Second Instalment date. Please enter the correct date'
        print (element.text)
