...
class thirdclaim(unittest.TestCase):
    ...
    def test_01_aadhaar_provided(self):
        ...
        #self.driver.switch_to.alert.accept()
        # Sent for approval
        element = self.driver.find_element_by_xpath('//*[@id="frm"]/div[9]/div/span[3]/span')
        assert element.text == 'Date of Child Birth must not be less than ANC date. Please enter the correct date'
        print (element.text)
