...
class thirdclaim(unittest.TestCase):
    def setUp(self):
        ...
        self.desig = ""
        self.contactaddr = ""
        self.url = "http://training8.pmmvy-cas.nic.in/BackOffice/UserAccount/Login"
    ...
    def test_01_aadhaar_provided(self):
        ...
        self.driver.find_element_by_id("Email").send_keys("ffdeo_automation3@mailinator.com")
        print("Email Entered")
        ...
        self.driver.find_element_by_xpath('//*[@id="txtNameAsInAadhar"]').send_keys('liana')
        ...
        self.driver.find_element_by_xpath('//*[@id="txtFNameAsInAadhaar"]').send_keys('lewis')
        ...
        self.driver.find_element_by_xpath('//*[@id="BankIFSCCode"]').send_keys('SBIN0000083')
        ...
        self.driver.find_element_by_xpath('//*[@id="txtAccountHoldersName"]').send_keys('liana')
