...
class thirdclaim(unittest.TestCase):
    ...
    def test_01_aadhaar_provided(self):
        ...
        #self.driver.switch_to.alert.accept()
        # Sent for approval
        element = self.driver.find_element_by_xpath('//*[@id="frm"]/div[20]/div/span[3]/span')
        assert element.text == 'Immunization Date must not be earlier than Date of Child Birth. Please enter the correct date'
        print (element.text)
